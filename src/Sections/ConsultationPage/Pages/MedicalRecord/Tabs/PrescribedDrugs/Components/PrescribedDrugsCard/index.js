        ...
        <div className="card MedicalRecord-CardSimple-4">
            ...
            <div className="card-body">
                <div style={{ display: 'flex', alignContent: 'center', alignItems: 'center' }}>
                    ...
                    <p>Profissional Prescrição: </p>
                </div>
                <p style={{ marginLeft: '30px', fontWeight: '400' }}>LARA LUIZA ALCHIMIM</p>
                <div style={{ display: 'flex', alignContent: 'center', alignItems: 'center' }}>
                    <i className="far fa-file-alt"></i>
                    <p>Anotações de Prescrição do Medicamento:</p>
                </div>
                <p style={{ marginLeft: '30px', fontWeight: '400' }}>Não foi informado anotações para o medicamento</p>
                <div style={{ display: 'flex', alignContent: 'center', alignItems: 'center' }}>
                    <i className="far fa-file-alt"></i>
