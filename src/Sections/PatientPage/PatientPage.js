                    ...
                    <div class="row">
                        <div class="col-xl-4 order-xl-2">
                            <div class="card card-profile">
                                <img src="../../assets/img/theme/img-1-1000x600.jpg" alt="placeholder" class="card-img-top" />
                                <div class="row justify-content-center">
                                    <div class="col-lg-3 order-lg-2">
                                        <div class="card-profile-image">
                                            <a href="!#">
                                                <img src="../../assets/img/theme/team-4.jpg" class="rounded-circle" alt="Descri" />
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <ul class="list-group list-group-flush list my--3">
                                        ...
                                        <li class="list-group-item px-0">
                                            <div class="row align-items-center">
                                                <div class="col-auto">
                                                    <a href="!#" class="avatar rounded-circle">
                                                        <img alt="placeholder" src="../../assets/img/theme/angular.jpg" />
                                                    </a>
                                                </div>
                                                <div class="col">
                                        ...
                                        <li class="list-group-item px-0">
                                            <div class="row align-items-center">
                                                <div class="col-auto">
                                                    <a href="!#" class="avatar rounded-circle">
                                                        <img alt="placeholder" src="../../assets/img/theme/sketch.jpg" />
                                                    </a>
                                                </div>
                                                <div class="col">
                                        ...
                                        <li class="list-group-item px-0">
                                            <div class="row align-items-center">
                                                <div class="col-auto">
                                                    <a href="!#" class="avatar rounded-circle">
                                                        <img alt="Imageplaceholder" src="../../assets/img/theme/react.jpg" />
                                                    </a>
                                                </div>
                                                <div class="col">
                                        ...
                                        <li class="list-group-item px-0">
                                            <div class="row align-items-center">
                                                <div class="col-auto">
                                                    <a href="!#" class="avatar rounded-circle">
                                                        <img alt="Imageplaceholder" src="../../assets/img/theme/vue.jpg" />
                                                    </a>
                                                </div>
                                                <div class="col">
